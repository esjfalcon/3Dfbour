...
<div class="page-wrapper">
    	...
    	<div class="main-box">
        	<div class="auto-container">
            	<div class="outer-container clearfix">
                    <!--Logo Box-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.html"><img src="images/logo3DF.png" alt=""></a></div>
                    </div>
                        ...
                        <nav class="main-menu">
                            ...
                            <div class="navbar-collapse collapse clearfix">
                                <ul class="navigation clearfix">
                                    ...
                                    <!-- <li class="dropdown"><a href="about-us.html">Qui somme-nous</a></li> -->
                                    <li class="dropdown"><a href="/about-us">Qui somme-nous</a></li>
                                    ...
                                    <li class="dropdown"><a href="/pricing">Nos Packs</a>
                                        <!-- <ul>
                                    ...
                                    <!-- <li class="dropdown"><a href="#">Pages</a>
                                     ...
                                     <li><a href="/registerr">Login / Register</a></li>
    ...
    <section class="hidden-bar right-align">
        ...
        <div class="hidden-bar-wrapper">
            ...
            <div class="logo text-center">
                <a href="index"><img src="images/logo3DF.png" alt=""></a>			
            </div><!-- /.logo -->
            ...
            <!-- .navigation -->
                <ul class="navigation">
                    <!-- <li class=""><a href="index-2.html">Home</a></li> -->
                        ...
                        <ul class="navigation clearfix">
                            <li class=""><a href="index">Acceuil</a></li>
                            <!-- <li class="dropdown"><a href="about-us.html">Qui somme-nous</a></li> -->
                            <li class=""><a href="about-us">Qui somme-nous</a></li>
                            <!-- <li class="dropdown"><a href="#">Services</a>
                                <ul>
                                    <li><a href="services.html">Our Services</a></li>
                                    <li><a href="service-single.html">Services Single</a></li>
                            ...
                            <li class="current"><a href="/pricing">Nos Packs</a>
                            ...
                            <!-- <li><a href="register.html">Login / Register</a></li> -->
                            <li></li><a href="{{ route('login') }}" class="btn btn-primary rounded">Login / Register</a></li>
        ...
        <div class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                    ...
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><h2>3D FABOUR</h2></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><div class="text">Quelque soit votre projet.<br>NOUS SOMME LÀ</div></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><div class="text text-center">Quelque soit votre projet.<br>NOUS SOMME LÀ</div></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><a href="/contact" class="theme-btn btn-style-one">Contact</a> &ensp; <a href="pricing.html" class="theme-btn btn-style-two">Nos Pack</a></div>
                    ...
                    data-endelementdelay="0.3"
                    data-endspeed="1200"
                    data-endeasing="Power4.easeIn"><a href="/contact" class="theme-btn btn-style-one">Contact</a> &ensp; <a href="pricing" class="theme-btn btn-style-two">Nos Packs</a></div>
        	...
        	<div class="row clearfix">
            	...
            	<div class="col-md-6 col-sm-12 col-xs-12 welcome-column">
                	...
                	<div class="inner-content wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                       ...
                       <br> 
                        <div class="text">3d fabour était devenu notre plus grande aventure. Notre objectif était de réaliser le meilleur service en ligne en 3D pour créer, dessiner et gérer tous vos projets.</div>
                        ...
                        <div class="author-title">
                        	<div class="author-info">équipe 3D FABOUR </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 service-column">
                	...
                	<div class="service-block-one">
                    	<div class="inner-box">
                            ...
                            <div class="text">Nous sommes intimement convaincus que les technologies 3D vont modifier le processus de décision d’achat des clients, tel qu’il existe aujourd’hui..</div>
                        </div>
                    </div>
                    <!--service-block-one-->
                    <div class="service-block-one">
                    	<div class="inner-box">
                            ...
                            <h3>Nous avons confiance</h3>
                            <div class="category"><a href="#">Membres de l'équipe</a></div>
                            <div class="text">3d fabour propose au consommateur un service gratuit pour imaginer, et voir votre projet avant de prendre une décision d’achat ou de réaménagement.</div>
                        </div>
                    </div>
                    <!--service-block-one-->
    ...
    <section class="pricing-section">
    	<div class="auto-container">
            ...
            <div class="sec-title medium">
            	<h2>Packs 3D FABOUR</h2>
                <div class="desc-text">Tous les packs de 3D FABOUR sont créés pour répondre à vos besoins à un prix très raisonnable</div>
            </div>
            
        	<div class="row clearfix">
            	
                <!--Pricing Column-->
            <form action="/demandescreate" method="GET">
                <div class="pricing-column col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="plan-title">FABOUR</div>
                        <div class="price-header"><span class="price"><sup>DH</sup> 0</span> <sub>/ HT</sub></div>
                        <div class="lower-content">
                        	<ul class="spec-list">
                                <li>2 vues en 3D</li>
                                <li>Résolution 1280*720</li>
                                <li>Durée 4 jours</li>
                                <br><br>
                            </ul>
                            <input type="hidden" value="FABOUR" name="name">
                            {{-- <a href="{{ route('login') }}" class="btn btn-primary rounded">Commander</a> --}}
                            {{-- <a href="/demandescreate" class="btn btn-primary rounded">Commander</a> --}}
                            <button type="submit" class="btn btn-primary rounded">Commander</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <form action="/demandescreate" method="GET">
                <div class="pricing-column col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="price-header"><span class="price"><sup>DH</sup> 590</span> <sub>/ HT</sub></div>
                        <div class="lower-content">
                        	<ul class="spec-list">
                                <li>Vue en plan 2D (pdf)</li>
                                <li>5 Rendus en 3D</li>
                                <li>Résolution 1920*1080</li>
                                <li>Durée 3 jours</li>
                            </ul>
                            
                            {{-- <a href="{{ route('login') }}" class="btn btn-primary rounded">Commander</a> --}}
                            <input type="hidden" value="Premium" name="name">
                            <button type="submit" class="btn btn-primary rounded">Commander</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="pricing-column col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="price-header"><span class="price"><sup>DH</sup> 1900</span> <sub>/ HT</sub></div>
                        <div class="lower-content">
                        	<ul class="spec-list">
                                <li>Vue en plan 2D (pdf)</li>
                                <li>8 Rendus en 3D</li>
                                <li>Résolution Haute HD 4K</li>
                                <li>Visite Virtuel</li>
                                <li>Durée 3 jours</li>
                            </ul>
                            
                            {{-- <a href="{{ route('login') }}" class="btn btn-primary rounded">Commander</a> --}}
                            <input type="hidden" value="Gold" name="name">
                            <button type="submit" class="btn btn-primary rounded">Commander</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="pricing-column col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="plan-title">Maquette</div>
                        <div class="price-header"><span class="price"><sup>A partir</sup> 5000</span> <sub>/ DH </sub></div>
                        <div class="lower-content">
                        	<ul class="spec-list">
                                <br>
                                <li>Selon la matiére préférée</li>
                            ...
                            {{-- <a href="{{ route('login') }}" class="btn btn-primary rounded">Commander</a> --}}
                            <input type="hidden" value="Maquette" name="name">
                            <button type="submit" class="btn btn-primary rounded">Commander</button>
                        </div>
                    </div>
                </div>
    ...
    <!--call-to-action-->
    <section class="call-to-action" style="background-image:url(images/background/photooxy-608c79ef2a650.jfif);">
    	<div class="auto-container">
        	<div class="row">
            	<!-- <div class="text">3D FABOUR</div> -->
                <h2>Votre nouvelle aménagement. <br> Pourquoi l’imaginer si vous pouvez le voir</h2>
                
                <a class="theme-btn btn-style-one" href="#">Accédez A la visite 360</a>
                <!-- <a class="theme-btn btn-style-two" href="#">Nos Pack</a> -->
    	...
    	<div class="auto-container">
        	...
        	<div class="row clearfix">
                ...
                <div class="service-block-three col-md-4 col-sm-6 col-xs-12">
                	<!--inner-box-->
                	<a href="" class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                ...
                <div class="service-block-three col-md-4 col-sm-6 col-xs-12">
                	<!--inner-box-->
                	<a href="" class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                    	<div class="icon-box"><span class="flaticon-house"></span></div>
                ...
                <div class="service-block-three col-md-4 col-sm-6 col-xs-12">
                	<!--inner-box-->
                	<a href="" class="inner-box wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                    	<div class="icon-box"><span class="flaticon-house"></span></div>
                        <h3>Animation 3D</h3>
                    </a>
                </div>
                                	...
                                	<div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value="" placeholder="Votre Nom" required>
                                            </div>
                                        </div>
     ...
     <footer class="main-footer" style="background-image:url(images/background/footer-bg.jpg);">
                    	...
                    	<div class="row clearfix">
                        	...
                        	<div class="footer-column col-md-6 col-sm-6 col-xs-12">
                            	<div class="footer-widget about-widget">
                                	<div class="footer-logo"><figure><a href="index"><img src="images/logo-footer.png" alt=""></a></figure></div>
                                    <div class="widget-content">
                                    	<div class="text">Quelque soit votre  <br> NOUS SOMME LÀ.</div>
                            	...
                            	<div class="footer-widget tags-widget">
                                    ...
                                    <div class="widget-content">
                                    	<ul class="contact-info">
                                        	<li><span class="icon fa fa-map-marker"></span>61 Av Lalla Yacout : Angel Mustapha El Maani . Etage 2 : N° 62 CASABLANCA </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <!--Footer Column-->
                        	 <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                            	<div class="footer-widget posts-widget">
                                	<div class="widget-content">
                                    	<ul class="contact-info">
                                        	<li><span class="icon fa fa-phone"></span>(+212) 000 000 000</li>
                                            <li><span class="icon fa fa-envelope-o"></span>contact@3dfabour.com</li>
                                        </ul>
                                    </div>
                                </div>
                            </div> 
        ...
        <!--Footer Bottom-->
         <div class="footer-bottom">
         	<div class="auto-container">
            	<div class="clearfix">
                	<div class="pull-left"><div class="copyright"><a href="https://www.yansoft.ma" target="_blank">YAN SOFT</a></div></div>
                    <div class="pull-right">
                    	<ul class="footer-nav">
                        	<li><a href="/index">Accueil</a></li>
                            <li><a href="/about-us">Qui somme-nous</a></li>
                            <li><a href="/pricing">Nos Packs</a></li>
                            <li><a href="/contact">Contact</a></li>
                        </ul>
                    </div>
                </div>
